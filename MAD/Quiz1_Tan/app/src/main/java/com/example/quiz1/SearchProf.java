...
public class SearchProf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_prof);
    ...
    public void search(View view) {
        ...
        String selection = Course.Courses.PROFESSOR + " LIKE?";
        String[] selectionArgs = { name + "%"};

        Cursor cursor = db.query(Course.Courses.TABLE_NAME, columns,
                selection, selectionArgs, null, null, Course.Courses.PROFESSOR);
